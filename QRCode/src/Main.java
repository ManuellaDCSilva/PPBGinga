...
public class Main {
	...
	public static void main(String[] args) {
		...
		QRCode qr = new QRCode(new Version(21, mode), new ErrorCorrectionLevel(ErrorCorrectionLevel.L), mode, "Testando");
//		QRCode qr = new QRCode(new Version(21, mode), new ErrorCorrectionLevel(ErrorCorrectionLevel.M), mode, "Testando");
//		QRCode qr = new QRCode(new Version(21, mode), new ErrorCorrectionLevel(ErrorCorrectionLevel.Q), mode, "Testando");
//		QRCode qr = new QRCode(new Version(21, mode), new ErrorCorrectionLevel(ErrorCorrectionLevel.H), mode, "Testando");
//		QRCode qr = new QRCode(new Version(21, mode), new ErrorCorrectionLevel(ErrorCorrectionLevel.L), mode, "Hello world");
//		QRCode qr = new QRCode(new Version(21, mode), new ErrorCorrectionLevel(ErrorCorrectionLevel.M), mode, "Hello world");
//		QRCode qr = new QRCode(new Version(21, mode), new ErrorCorrectionLevel(ErrorCorrectionLevel.Q), mode, "Hello world");
//		QRCode qr = new QRCode(new Version(21, mode), new ErrorCorrectionLevel(ErrorCorrectionLevel.H), mode, "Hello world");
//		QRCode qr = new QRCode(new Version(21, mode), new ErrorCorrectionLevel(ErrorCorrectionLevel.L), mode, "Casos de teste");
//		QRCode qr = new QRCode(new Version(21, mode), new ErrorCorrectionLevel(ErrorCorrectionLevel.M), mode, "Casos de teste");
//		QRCode qr = new QRCode(new Version(21, mode), new ErrorCorrectionLevel(ErrorCorrectionLevel.Q), mode, "Casos de teste");
//		QRCode qr = new QRCode(new Version(21, mode), new ErrorCorrectionLevel(ErrorCorrectionLevel.H), mode, "Casos de teste");
